...
namespace GerenciadorJogos.Generico.Repositorio
{
    public class RepositorioGenerico<TDominio, TChave> : IRepositorioGenerico<TDominio, TChave> where TDominio : class
    {
